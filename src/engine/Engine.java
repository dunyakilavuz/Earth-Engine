...
public class Engine 
{
	...
	{
		activeScene = EngineReferences.activeScene;
		...
		window = GLFW.glfwCreateWindow(EngineReferences.WindowWidth,
				EngineReferences.WindowHeight, 
				EngineReferences.WindowTitle, 0, 0);
		if ( window == 0 )
		{
		...
		GLFW.glfwSetWindowPos(window,(vidmode.width() - EngineReferences.WindowWidth) / 2,
				(vidmode.height() - EngineReferences.WindowHeight) / 2);
	...
	void MouseTeleporting()
	{
		...
		{
			if(Input.Mouse.MousePosition().x >= EngineReferences.WindowWidth)
			{
				GLFW.glfwSetCursorPos(window, 0.01f, Input.Mouse.MousePosition().y);
			}
			else if(Input.Mouse.MousePosition().x <= 0)
			{
				GLFW.glfwSetCursorPos(window, EngineReferences.WindowWidth, Input.Mouse.MousePosition().y);
			}
			
			else if(Input.Mouse.MousePosition().y >= EngineReferences.WindowHeight)
			{
				GLFW.glfwSetCursorPos(window, Input.Mouse.MousePosition().x,0.01f);
			}
			else if(Input.Mouse.MousePosition().y <= 0)
			{
				GLFW.glfwSetCursorPos(window, Input.Mouse.MousePosition().x,EngineReferences.WindowHeight);
			}
		}
	}
